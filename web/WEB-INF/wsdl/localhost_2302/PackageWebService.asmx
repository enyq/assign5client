...
<html>
    ...
    <head><link rel="alternate" type="text/xml" href="/PackageWebService.asmx?disco" />
  ...
  <body>
    ...
    <div id="content">
      ...
      <p class="heading1">PackageWebService</p><br>

      

      <span>

          <p class="intro">The following operations are supported.  For a formal definition, please review the <a href="PackageWebService.asmx?WSDL">Service Description</a>. </p>
          
          
              <ul>
            
              <li>
                <a href="PackageWebService.asmx?op=AddPackage">AddPackage</a>
              ...
              <li>
                <a href="PackageWebService.asmx?op=RegisterPackage">RegisterPackage</a>
              ...
              <li>
                <a href="PackageWebService.asmx?op=RemovePackage">RemovePackage</a>
...
<script type="application/json" id="__browserLink_initializationData">
    {"appName":"Unknown","requestId":"b246322b305f4310becc549217f2a41d"}
</script>
<script type="text/javascript" src="http://localhost:4770/7fb87e55048d40378c55682ac133799d/browserLink" async="async"></script>
<!-- End Browser Link -->
