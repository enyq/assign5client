 ...
 * 
 */
@WebServiceClient(name = "NewWebService", targetNamespace = "http://userLoginAndRegister.tema5.sd.utcluj.edu/", wsdlLocation = "http://localhost:8080/NewWebService/UserWebService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName NEWWEBSERVICE_QNAME = new QName("http://userLoginAndRegister.tema5.sd.utcluj.edu/", "NewWebService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/NewWebService/UserWebService?wsdl");
    ...
    public UserWebService getUserWebServicePort() {
        return super.getPort(new QName("http://userLoginAndRegister.tema5.sd.utcluj.edu/", "UserWebServicePort"), UserWebService.class);
    }
    ...
    public UserWebService getUserWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://userLoginAndRegister.tema5.sd.utcluj.edu/", "UserWebServicePort"), UserWebService.class, features);
    }
